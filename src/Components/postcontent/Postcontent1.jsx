...
import WalkIm from '../../Assets/Animations/ballwithlegs.PNG'
import JumpIm from '../../Assets/Animations/ballwithtail.PNG'
import TattooIm from '../../Assets/Animations/scream2.PNG'
import JingleIm from '../../Assets/Animations/singing1.PNG'
import WithIm from '../../Assets/Animations/wothyou3.PNG'



export default function Postcontent1() {
  return (
...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      ...
      <iframe width="560" height="315" src="https://youtube.com/embed/CgSTeHxe3pU?feature=share"
    ...
    <div class="card">
      <h2>Jumping ball with tail</h2>
      <h5>Made in 2021</h5>

      <iframe width="560" height="315" src="https://www.youtube.com/embed/XBiE7udfEU8"
    ...
    <div class="card">
      <h2>Short 10 second clip</h2>
      <h5>Made in 2021</h5>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/3LP9AhQUgFs" 
      title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; 
      gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    ...
    <div class="card">
      <h2>Lip sync animation</h2>
      <h5>Made in 2022</h5>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/6PT6mx24dbw" title="YouTube video player" 
    ...
    <div class="card">
      <h2>Lyric video </h2>
      <h5>Made in 2022</h5>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/NmmSirCg8Yw" 
